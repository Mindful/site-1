...
BLOG_AUTHOR = "Joshua Tanner"  # (translatable)
BLOG_TITLE = "Joshua Tanner"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://joshuatanner.dev/"
...
INDEX_PATH = 'blog'  # index location for posts
    ...
    <div>
        ...
        <span class="fa-stack fa-2x">
          <a href="https://stackexchange.com/users/5319885/mindful">
            <i class="fa fa-circle fa-stack-2x"></i>
            <i class="fa fa-stack-exchange fa-inverse fa-stack-1x"></i>
          </a>
        </span>
        <span class="fa-stack fa-2x">
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code',
                       ...
                       'markdown.extensions.nl2br',  # like Github's markdown
                       'markdown.extensions.tables',  # like Github's markdown
                       'markdown.extensions.sane_lists',  # like Github's markdown
